<div class="flex flex-col self-center p-6 rounded-2xl shadow-2xl sm:w-1/3 md:w-1/2 lg:w-1/3 my-40 ">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Tambahkan Item Disini!!!</h2>
        </div>
        ...
        <div class="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            @endif
            <form enctype="multipart/form-data"  class="space-y-6" action="{{ route('storeItemPage', ['name' => $shop->name]) }}" method="POST">
                @csrf
                <div>
