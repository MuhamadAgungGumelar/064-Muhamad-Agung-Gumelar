<div class="flex flex-col self-center px-14 py-12 w-fit lg:px-20 rounded-2xl shadow-2xl">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Daftar Warung Disini!!!</h2>
        </div>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            @endif
            <form enctype="multipart/form-data" class="space-y-6" action="{{ route('sellerRegistrationPage', ['name' => $user->name]) }}" method="POST">
                @csrf
                <div>
                    ...
                    <div class="mt-2">
                        <textarea name="description" id="description" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                    </div>    
                    ...
                    <div class="flex items-center justify-center w-full mt-4">
                        <label for="image" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            ...
                            <input id="image" name="image" type="file" class="hidden w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" />
                        </label>
                    </div> 
