<div class="flex flex-col justify-center px-14 py-12 lg:px-20 rounded-2xl shadow-2xl">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            @endif
            <form class="space-y-6" action="{{ route('sellerRegistrationPage', ['name' => $user->name]) }}" method="POST">
                @csrf
                <!-- <div>
                ...
                <div>
                    <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Shop Name</label>
                    <div class="mt-2">
