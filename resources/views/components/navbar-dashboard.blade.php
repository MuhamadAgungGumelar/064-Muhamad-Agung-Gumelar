<header x-data="{ isOpen: false, isOn: false, isActive: false }" class="absolute inset-x-0 top-0 z-50">
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    ...
    <div class="hidden lg:flex lg:gap-x-12">
      ...
      <a href="{{ route('viewCart', ['name' => $user->name]) }}" class="text-sm font-semibold leading-6 text-gray-900">Cart</a>
      <a href="#contact" class="text-sm font-semibold leading-6 text-gray-900">Contact</a>
    </div>
    <div class="hidden lg:flex lg:flex-1 lg:justify-end">
      @if(session()->get("isLogged"))
          <a href="{{ route('logout') }}" class="text-sm font-semibold leading-6 text-gray-900">{{$user->name}} <span aria-hidden="true">&rarr;</span></a>
      @else
  ...
  <div x-show="isActive" class="lg:hidden" role="dialog" aria-modal="true">
